      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-2 mb-6">
              <div className="h-8 w-8 rounded-md bg-gradient-to-tr from-timewise-400 to-timewise-600 flex items-center justify-center">
        ...
        <div className="mt-16 pt-8 border-t border-timewise-800 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6">
            <a href="#" className="text-timewise-400 hover:text-white transition-colors">
